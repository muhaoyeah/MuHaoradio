...
var userPlaylists = [], neteasePlaylists = [], qqPlaylists = [], kugouPlaylists = [], kugouLitePlaylists = [], qishuiPlaylists = [], spotifyPlaylists = [], myPodcastCollections = [], myPodcastItems = {}, playlistCoverCache = {};
